...
windows:
	g++ -c src/*.cpp -I includeSDL -L lib --std=c++14 -g -Wall -m64 -I include -lmingw32 -lSDL2main -lSDL2 && g++ *.o -o bin/debug/main -L -lSDL2main -lSDL2 -lSDL2_image -lSDL2_ttf -lSDL2_mixer && ./bin/debug/main && rm *.o
